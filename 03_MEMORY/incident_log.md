...
| INC-005 | 2026-07-04 | scheduler | Runtime Failure: unique constraint violation | Duplicate opportunities on repeated pipeline runs raise index errors on insert | Patched query to use ON CONFLICT DO NOTHING and logged skipped counts | Closed |
